    ...
    <main className="relative min-h-screen bg-background text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-5 lg:px-12 pt-36 pb-16">
        ...
        <div className="text-center mb-16">
          <p className="uppercase tracking-[1px] text-[13px] text-white/80 mb-4 font-normal">
            Featured Project
          </p>
          <h1
          ...
          <p className="max-w-[700px] mx-auto text-lg text-white/90 leading-[1.6]">
            {project.description}
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {project.tags.map((tag) => (
              <span
                key={tag}
                className="px-4 py-2 rounded text-xs font-medium bg-white/8 text-white/90 uppercase tracking-[0.5px]"
              >
                {tag}
              </span>
            ))}
        ...
        <section className="mb-16">
          ...
          <div className="space-y-5">
            {project.about.map((paragraph, index) => (
              <p key={index} className="text-base text-white/90 leading-[1.8]">
                {paragraph}
              </p>
            ))}
          </div>
        ...
        <div className="flex justify-center my-16">
          <div className="w-8 h-8 rounded-full ring-1 ring-white/20 flex items-center justify-center">
